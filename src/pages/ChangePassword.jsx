...
import { 
  Form, Input, Button, Card, Alert, message, Typography, Space, 
  Row, Col, Progress, Tooltip, Grid
} from 'antd';
import { 
  LockOutlined, EyeInvisibleOutlined, EyeTwoTone, 
  CheckCircleOutlined, CloseCircleOutlined, SafetyOutlined,
  SecurityScanOutlined, KeyOutlined
    ...
    >
      ...
      <Row justify="center" style={{ marginTop: '32px' }}>
        <Col xs={24} sm={20} md={16} lg={12} xl={10}>
          ...
          >
            <Card 
              className="change-password-card-modern"
              style={{
                borderRadius: '20px',
                border: '1px solid #f0f0f0',
      ...
      <style jsx>{`
        ...
        .change-password-card-modern {
          transition: all 0.3s ease;
        }

        .change-password-card-modern:hover {
        ...
        @media (max-width: 768px) {
          ...
          .change-password-card-modern .ant-card-body {
